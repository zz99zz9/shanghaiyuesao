    ...
    <!--#include virtual="logo.asp"-->
      <table width="979" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="754" align="left" valign="top" style="color:#FCFBA8;"><img src="images/right_contact.jpg" width="781" height="21" /><br />
          <br />
          <table width="781" border="0" cellspacing="0">
  <tr>
    <td width="781" valign="top" style="padding:15px;line-height:150%;"><%call sHowInfo("��ϵ����")%></td>
  </tr>
  <tr>
    <td align="center" valign="top" style="padding:15px;line-height:150%;"><iframe id='mapbarframe' border='0' vspace='0' hspace='0' marginwidth='0' marginheight='0' framespacing='0' frameborder='0'scrolling='no' width='645' height='400' src='http://searchbox.mapbar.com/publish/template/template1010/index.jsp?CID=zz99zz9&tid=tid1010&showSearchDiv=1&cityName=%E5%8C%97%E4%BA%AC%E5%B8%82&nid=MAPBTNJAQBXWQBXWZRHPX&width=645&height=400&infopoi=2&zoom=10&control=1'></iframe><br /></td>
  </tr>
          </table>
</td>
        </tr>
