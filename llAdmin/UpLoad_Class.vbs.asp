...
Class UploadFileEx
	Private mvarFormName , mvarNewName , mvarLocalName , mvarFileName , mvarUserSetName , mvarContentType ,mException
	...
	Public Function SaveToFile(ByVal Path , tOption, OverWrite)
	...
	Public Function GetWH()
		...
		if instr("|jpg|jpeg|bmp|png|gif|","|" & mvarExtend & "|")<=0 then exit function
		Dim m_binItem
