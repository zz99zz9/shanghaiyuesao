...
<tr><td height='100%'>
	...
	<table border=0 cellpadding=0 cellspacing=0 width='100%' height='100%'>
	<tr><td height='100%'>
	<input type="hidden" ID="ContentEdit" value="" style="background:#6C2600;">
	<input type="hidden" ID="ModeEdit" value="" style="background:#6C2600;">
	<input type="hidden" ID="ContentLoad" value="" style="background:#6C2600;">
	<input type="hidden" ID="ContentFlag" value="0" style="background:#6C2600;">
