...
if(navigator.userAgent.match(/(iPhone|iPod|Android|ios)/i)){
	location.href="http://wap.shanghaiyuesao.com/index.asp"; //可以换成http地址
}

</script>

<script src="http://siteapp.baidu.com/static/webappservice/uaredirect.js" type="text/javascript"></script>
<script type="text/javascript">uaredirect("http://wap.shanghaiyuesao.com");</script>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?69bf05bb6867c7d7f38430817d0f8865";
  ...
  <div id="index_all">
	...
	***********************************************/
	...
	// ]]>
      ...
      <!-------------------------->
      <div style="position:absolute;width:740px; margin-left:130px;z-index:5;margin-top:430px;height:120px;">
      <style type="text/css"> 
<!--
#demo {
overflow:hidden;
...
<div id="indemo">
<div id="demo1">
<%sql="select top 20 * from [table_product] where passed=true and Elite=true order by Product_Id,articleId "
...
<!--FrontPublic_slideShow01 start-->
              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="1002" height="450">
                <param name="movie" value="flash/typeB.swf" />
                <param name="quality" value="high" />
                <param name="wmode" value="opaque" />
                <embed src="flash/typeB.swf" quality="high" wmode="opaque" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="1002" height="450"></embed>
              </object>
...
<EMBED height=180 type=application/x-shockwave-flash align=middle width=300 src=http://player.youku.com/player.php/sid/XMzg4MDAwMzc2/v.swf allowFullScreen="true" quality="high" allowScriptAccess="always"></EMBED>
...
pagesize=6	
set rs=server.CreateObject("adodb.recordset")
sql="select * from news where newskinds='最新视频' order by NEwsId desc"
rs.open sql,conn,3,3
if rs.eof then
else
                    ...
                    <li class="content column-num1">
                      <div class="main">
                        <div class="newstitle">
                          <ul>
                            <li class="title">
                              <img src="images/dot.jpg" /> <a href="Knowledge_view.asp?id=<%=rs("newsid")%>&amp;Action=<%=Rs("NewsKinds")%>" style="color:#FFF8B7;" target="_blank"><%=rs("newstitle")%></a>
                            </li>
...
%>
          ...
          <div id="middle02_02"> <img src="/images/pic/right_011.jpg" alt="right_01" width="170"  height="38" />
              ...
              <div xmlns="" class="columnSpace" id="elem-FrontSpecifies_show01-1355124110119" name="说明页">
                <div id="FrontSpecifies_show01-1355124110119" class="FrontSpecifies_show01-d3_c1">
                  <div class="describe htmledit">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center"><a href="about.asp" style="color:#FFF8B7;"><img src="images/4.jpg" width="141" height="141" style="margin-bottom:10px;"/><br />
                        查看详细</a></td>
                        <!-- width="48%"td width="52%" style="line-height:150%;"><%call sHowInfo_1("雯红简介",120)%><br />[<a href="about.asp" style="color:#fff8b7;">更多</a>]</td-->
                      </tr>
                    </table>
                  </div>
                </div>
      ...
      <div id="middle_right" align="left"> <img src="/images/pic/index_hj.jpg" style="margin-left:5px;"/>
...
<%do while not rs.eof%>
          <li class="content column-num2">
                          <div class="pic-module">
                            <div class="pic"><a href="fwnr.asp" ><!--<%=rs("prod_detail")%>--><img  src="<%=rs("prod_pic")%>"  height="125" border="0" /></a></div>
                          </div>
...
//]]>
          ...
          <!----------------------<a href="fwnr.asp" target="_blank"><img src="images/pic/fw.gif" width="447" height="452" border="0"/></a>---------->
    ...
    <div id="middle_03">
      <div id="middle_03_01" align="left"><img alt="middle03_01" src="/images/pic/middle03_01.jpg" />
...
<div id="scroll_begin">
<%set rs=server.CreateObject("adodb.recordset")
sql="select * from prod where kid_id=1 order by Prod_Id desc"
rs.open sql,conn,3,3%>
<ul>
<%do while not rs.eof%>
