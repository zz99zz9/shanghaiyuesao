...
<div class="pageWidth" id="box_root">
  ...
  <!--#include virtual="left.asp"-->
          ...
          <td width="754" align="left" valign="top" style="color:#FCFBA8;"><img src="images/right_fwcn.gif" width="781" height="21" /><br />
          <br />
          <table width="781" border="0" cellspacing="0">
  <tr>
    <td width="781" valign="top" style="padding:15px;line-height:150%;"><%call sHowInfo("服务承诺")%></td>
  </tr>
</table>
</td>
        </tr>
